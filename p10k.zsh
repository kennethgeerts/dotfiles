# Generated by Powerlevel10k configuration wizard on 2024-02-13 at 13:58 CET.
...
() {
  ...
  # Context format when root: user@host. The first part white, the rest red.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE="%F{$white}%n%f%F{$red}@%m%f"
  # Context format when not root: user@host. The whole thing yellow.
